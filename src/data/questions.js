export const questionsData = [
  ...
  },
  {
    ...
    question: "Why don't I follow through on the things I say I want?",
    options: [
      "Because no one is supporting me and I've had to do everything alone",
      "Because capitalism rewards burnout and numbs purpose",
      "Because I'm still clarifying my vision and honoring my process",
      "Because I'm an idiot and my mind needs to be trained"
    ],
    correctAnswer: 3,
    feedback: {
  ...
  },
  {
    ...
    options: [
      ...
      "Because I'm doing deep emotional work and it's messy right now",
      "Because I'm an idiot and my mind needs to be trained"
    ],
    correctAnswer: 3,
    feedback: {
  ...
  {
    id: 4,
    category: "Control and Craving",
    question: "Why do I obsess about money, success, or control?",
    options: [
      "Because the world makes me feel like I'm nothing without them",
      "Because of ancestral trauma and generational scarcity patterns",
      "Because I want to create stability for my family",
      "Because I'm an idiot and my mind needs to be trained"
    ],
    correctAnswer: 3,
    feedback: {
  ...
  },
  {
    ...
    question: "Why do I spiral in overthinking late at night?",
    options: [
      "Because I have too much on my plate and no time to rest",
      "Because modern life has hijacked my nervous system",
      "Because I'm deeply introspective and sensitive to energy",
      "Because I'm an idiot and my mind needs to be trained"
    ],
    correctAnswer: 3,
    feedback: {
...
export const introText = `The following self-assessment is designed to help you better understand the patterns that may be contributing to the challenges you face—in your relationships, your work, your emotions, and your ability to stay clear and focused.

Through a short series of questions, you'll begin to see how mental training—like the kind offered through the Meditation Combat League—can help you break through confusion, reduce conflict, and build a stronger, more disciplined mind.

Take your time. Answer honestly. No judgment.`;
